...
import { createStyles, rrStyles } from './styles';
        ...
        >
          ...
          >
            ...
            >
              ...
              {step === 1 && (
                <>
                  <SectionHeaderText title="Personal Information" />
                  <FormTextInput
                    control={control}
                    name="fullName"
                    label="Full Name *"
              ...
              {step === 2 && (
                <>
                  <SectionHeaderText title="KYC Documents" />
                  <FormTextInput
                    control={control}
                    name="panNumber"
                    label="PAN Number"
              ...
              {step === 3 && (
                <>
                  <SectionHeaderText title="Address Details" />
              ...
              {step === 4 && (
                <>
                  <SectionHeaderText title="Review Your Details" />
